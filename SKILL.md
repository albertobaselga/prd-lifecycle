...
============================================================================
Phase 1 instructions are in a dedicated file loaded by the brain.
Run brain → follow the LOAD file → jump to RESUME AT section.
See: phases/phase1-specification.md

(Steps 0.1-0.7 above run before the brain has loadFile guidance.
 Phase 1 ceremonies, shutdown, commit, and transition are in the file.)
